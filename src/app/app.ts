...
export class App implements OnDestroy {
  ...
  readonly results: Result[] = [
    { src: '/resultado1.jpeg', alt: 'Transformação física — resultado 1' },
    { src: '/resultado2.jpeg', alt: 'Transformação física — resultado 2' },
    { src: '/resultado3.jpeg', alt: 'Transformação física — resultado 3' },
    { src: '/resultado4.jpeg', alt: 'Transformação física — resultado 4' },
    { src: '/resultado5.jpeg', alt: 'Transformação física — resultado 5' },
    { src: '/resultado6.jpeg', alt: 'Transformação física — resultado 6' },
    { src: '/resultado7.jpeg', alt: 'Transformação física — resultado 7' },
    { src: '/resultado8.jpeg', alt: 'Transformação física — resultado 8' },
  ];
